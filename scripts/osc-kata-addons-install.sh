...
update_provider_config() {
    ...
    local config_file="/etc/kata-containers/configuration-${provider}.toml"
...
install_addons() {
    ...
    local install_dir="/usr/share/kata-containers"
...
uninstall_addons() {
    ...
    if [ -n "$provider" ]; then
        # local config_file="/etc/kata-containers/configuration-${provider}.toml"
        local config_file="/etc/kata-containers/configuration.toml"
